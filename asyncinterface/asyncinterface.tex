...
\@x{}\moduleLeftDash\@xx{ {\MODULE} asyncinterface}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} TLC ,\, Naturals}%
\@x{ {\CONSTANT} Data}%
\@x{ {\VARIABLES} val ,\, rdy ,\, ack}%
\@x{ Init\@s{5.17} \.{\defeq} \.{\land} val\@s{2.08} \.{\in} Data}%
\@x{\@s{40.87} \.{\land} rdy\@s{0.83} \.{\in} {\BOOLEAN}}%
\@x{\@s{40.87} \.{\land} ack \.{=} rdy}%
\@x{ Send \.{\defeq} \.{\land} rdy\@s{0.83} \.{=} ack}%
\@x{\@s{40.87} \.{\land} val \.{'}\@s{1.25} \.{\in} Data}%
\@x{\@s{40.87} \.{\land} rdy \.{'} \.{=} 1 \.{-} rdy}%
\@x{\@s{40.87} \.{\land} {\UNCHANGED} ack}%
\@x{ Rcv \.{\defeq}\@s{4.92} \.{\land} rdy \.{\neq} ack}%
\@x{\@s{40.87} \.{\land} ack \.{'} \.{=} 1 \.{-} ack}%
\@x{\@s{40.87} \.{\land} {\UNCHANGED} {\langle} val ,\, rdy {\rangle}}%
...
\ensuremath{{\THEOREM}} \ensuremath{Spec \.{\implies} {\Box}Init
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ceqdash{4}
